...
namespace CalendarPetProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            return View("~/Views/CustomerSupport/ContactSupport.cshtml");
        }
        public IActionResult ThanksForSupportRequest() 
        {
            return View();
        }
